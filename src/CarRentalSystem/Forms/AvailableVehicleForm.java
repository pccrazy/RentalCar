...
public class AvailableVehicleForm extends JFrame {
  ...
  private void initComponents() {
    ...
    jPanelImageHolder = new javax.swing.JLabel();
    jBtnRemoveCar = new javax.swing.JButton();
    jButtonClose = new javax.swing.JButton();
    jUsername.setText(CurrentUser.getUsername());


    setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

    jPanelStartTime.setBorder(
    ...
    jButtonConfirmBooking.addActionListener(
        evt -> {
          try {
            jButtonConfirmBookingActionPerformed();
          } catch (ArrayIndexOutOfBoundsException ex) {
            JOptionPane.showMessageDialog(null, "Please select the car first");
          }
        });

    jListAvailableVehicles.addListSelectionListener(e -> listChangeListener(e));

    rentStartDate.setCurrentView(
        new datechooser.view.appearance.AppearancesList(
            "Light",
            new datechooser.view.appearance.ViewAppearance(
                "custom",
                new datechooser.view.appearance.swing.SwingCellAppearance(
                    new java.awt.Font("Tahoma", java.awt.Font.PLAIN, 13),
    ...
    jListAvailableVehicles.setModel(
        ...
        jPanel2Layout
            ...
            .addGroup(
                jPanel2Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        jLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                    .addContainerGap()));

    if(!CurrentUser.getType().equals("admin")){
      jBtnRemoveCar.setVisible(false);
    }
    jBtnRemoveCar.setText("Remove Car");
    jBtnRemoveCar.addActionListener(evt -> jBtnRemoveCarActionPerformed());
  ...
  private javax.swing.JButton jBtnRemoveCar;
